...
// console.log(getAllDirectors(themovies))
...
gettingUniqueDirectors(themovies)


// Iteration 2: Steven Spielberg. The best? - How many drama movies did STEVEN SPIELBERG direct?

function howManyMovies(moviesArr) {
    let SpielbergMovies = moviesArr.filter(movie => movie.director === 'Steven Spielberg' && movie.genre.includes('Drama'))

// console.log('SpielbergMovies',SpielbergMovies)
// console.log('SpielbergMovies Length',SpielbergMovies.length)
...
//     let sumRating = moviesArr.reduce((accumulator, currentValue) => { 
...
//     let average = +((sumRating / moviesArr.length).toFixed(2));
...
function dramaMoviesRate(moviesArr) {
    ...
    let dramaArr = moviesArr.filter(movie => movie.genre.includes('Drama'))
    // console.log('dramaArr',dramaArr)

    if (dramaArr.length === 0) return 0;

    let sumRating = dramaArr.reduce((accumulator, currentValue) => { 
        if(!currentValue.rate) {
            return accumulator + 0
        }
        return (accumulator + currentValue.rate)
    }, 0)
    let averageDrama = +((sumRating/dramaArr.length).toFixed(2));
// console.log('averageDrama',averageDrama)
    return averageDrama
...
// dramaMoviesRate(themovies)

// Iteration 5: Ordering by year - Order by year, ascending (in growing order)

function orderByYear(moviesArr) {
// creating a duplicate array
    let duplicateArr = moviesArr.map(movie => movie)


    // let sortedArr = duplicateArr.sort((a, b) => a.year - b.year)
    
    let sortedArr = duplicateArr.sort((a,b) => {
        if (a.year === b.year) {
...
orderByYear(themovies)


// // orderByTitle
// function orderByTitle (moviesArr) {
//     let duplicateArr = moviesArr.map(movie => movie)
...
// orderByTitle(themovies)

// Iteration 6: Alphabetic Order - Order by title and print the first 20 titles

function orderAlphabetically(moviesArr) {
    let listOfMovies = [...moviesArr];

    let sortedArr = listOfMovies.sort((a, b) => {
        if (a.title > b.title){
            return 1;
        }
